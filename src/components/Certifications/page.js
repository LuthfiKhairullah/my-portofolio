...
export default function Certifications() {
  return (
    <>
      <section className="d-flex justify-content-center my-5" id="certifications">
        <div className="card" style={{width: "90%"}}>
          <div className="container-fluid my-5" data-aos="fade-up">
            ...
            <div id="carouselExampleIndicators" className="carousel carousel-dark slide" data-bs-ride="carousel">
              <div className="carousel-inner px-5 container">
              ...
              <button className="carousel-control-prev" style={{width: "5%", color: "black"}} type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="prev">
